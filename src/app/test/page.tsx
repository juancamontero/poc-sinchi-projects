  ...
  return (
    <div className='bg-gray-100'>
      <aside className='fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] dark:bg-gray-800 dark:border-gray-700'>
        <div>
          {/* Brand widget start */}
          <div className='-mx-6 px-6 py-4 flex flex-row gap-1'>
            <a href='#' title='home'>
              <GoProjectRoadmap
                size={28}
                className='mx-auto text-[#943A4A] mb-3'
              />
              {/* <Image
                width={28}
                height={28}
            ...
            <div className=' flex flex-col flex-wrap justify-start items-start'>
              <h1 className='hidden text-base font-semibold text-gray-600 lg:block ml-1'>
                SINCHI - Prueba concepto
              </h1>
              <h2 className='hidden text-xs font-semibold text-gray-600 lg:block ml-1'>
                Propuesta portal proyectos
              </h2>
            </div>
          </div>
          {/* Brand widget end */}
          ...
          <ul className='mt-8 space-y-2 tracking-wide'>
            <li>
              ...
              >
                ...
                <span className='-mr-1 font-medium'>Ecosistemas y recursos naturales</span>
              </a>
            </li>
            <li>
              <a
